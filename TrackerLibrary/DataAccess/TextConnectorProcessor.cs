...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        {
            //C:\Users\valer\source\repos\TournamentTracker\PrizeModels.csv
            return $"{ ConfigurationManager.AppSettings["filePath"] }\\{ fileName }";
        }

        public static List<string> LoadFile(this string file) //Corresponds to load the file task
        {
            if (!File.Exists(file))
            {
        ...
        {
            //1.Loop through each round
            //2.Loop through each Matchup
            //3.Get the Id for the new Matchup and save the record
            //4.Loop through each Entry, get the Id and save it
