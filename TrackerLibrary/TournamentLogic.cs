...
namespace TrackerLibrary
{
    ...
    {
        //1.Order our list of teams randomly
        //2.Take this list and check it if it is big enough  - if not, add in byes
        //3.Create our first round of matchups
        //4.Create every round after that. 8 matchups - 4 matchups - 2 matchups - 1 matchup
        ...
        private static void CompleteTournament(TournamentModel model)
        {
            ...
            body.Append("<p>Congratulations to our winner on a great tournmaent</p>");
        ...
        private static void MarkWinnersInMatchups(List<MatchupModel> models)
        {
            ...
            foreach (MatchupModel m in models)
            {
                ...
                if (greaterWins == "0")
                {
                    ...
                    {
                        throw new Exception("We do not allow ties in this applications.");
                    }
                }
                else
                {
        ...
        {
            int round = 2; //it represents the current round we are in
